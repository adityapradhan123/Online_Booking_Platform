        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 fs-5 text-center">
              ...
              <li class="nav-item">
                <a class="nav-link text-success" href="login2/index.php" >Login</a>
              </li>
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-12 ">
            <div class="card">
                <div class="card-body">
                  ...
                  <a href="http://localhost/classroom1/login2/index.php" class="btn btn-success mt-2">Book Now</a>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-12 ">
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <a href="http://localhost/classroom1/login2/index.php" class="btn bg-success mt-4 text-white">Book Now</a>
                ...
                <div class="col-sm-12 col-md-4 col-lg-4 col-12 ">
                    ...
                    <div class="card">
                        <div class="card-body">
                          ...
                          <a href="http://localhost/classroom1/login2/index.php" class="btn btn-success mt-3">Book Now</a>
                          <h2 class="offer text-center text-dark">20% off</h2>
                        </div>
                    </div>
